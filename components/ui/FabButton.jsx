      ...
      {/* <div className="gap-3"> */}
        {openSubMenu && (
          <ul>
           ...
           <button className="bg-[#cdad8f] flex items-center justify-center w-13 h-13 xs:w-11 xs:h-11 text-white rounded-full shadow-lg transition-transform hover:scale-110">
